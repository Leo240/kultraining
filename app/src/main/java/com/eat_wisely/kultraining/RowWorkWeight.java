...
public class RowWorkWeight extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        final TextView tvRowWeight = (TextView) getActivity().findViewById(R.id.tvRowWeight);

        String s = tvRowWeight.getText().toString();
        ...
        builder.setTitle("Введите вес")
                .setPositiveButton("Записать", new DialogInterface.OnClickListener(){
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        tvRowWeight.setText(workWeight + "кг");
                    }
                })
                .setNegativeButton("Отмена", new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        RowWorkWeight.this.getDialog().cancel();
                    }
                });
