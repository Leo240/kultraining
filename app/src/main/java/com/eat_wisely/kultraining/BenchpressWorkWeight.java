...
public class BenchpressWorkWeight extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        final TextView tvBenchWeight = (TextView) getActivity().findViewById(R.id.tvBenchWeight);

        String s = tvBenchWeight.getText().toString();
        ...
        builder.setTitle("Введите вес")
                .setPositiveButton("Записать", new DialogInterface.OnClickListener(){
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        tvBenchWeight.setText(workWeight + "кг");
                    }
                })
                .setNegativeButton("Отмена", new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        BenchpressWorkWeight.this.getDialog().cancel();
                    }
                });
